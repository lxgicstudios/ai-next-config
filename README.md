...
![npm](https://img.shields.io/npm/v/ai-next-config)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-next-config)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Next.js configuration optimization and utilities

Next.js configuration generator. Creates optimized config files for performance and SEO.

[![npm version](https://img.shields.io/npm/v/ai-next-config.svg)](https://www.npmjs.com/package/ai-next-config)
[![npm downloads](https://img.shields.io/npm/dm/ai-next-config.svg)](https://www.npmjs.com/package/ai-next-config)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![GitHub stars](https://img.shields.io/github/stars/lxgicstudios/ai-next-config)](https://github.com/lxgicstudios/ai-next-config/stargazers)
